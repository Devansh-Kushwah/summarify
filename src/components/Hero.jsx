...
function hero(){
  return (
    <div >
      ...
      <div className="upperEffect absolute inset-x-0 blur-3xl transform-gpu overflow-hidden z-[-10] sm:-top-80"
          aria-hidden="true">
          ...
          <div className="text-center">
            ...
            Uncover the Emotion: Transform YouTube Links into Sentiments with a Single Click!            </p>
          </div>
